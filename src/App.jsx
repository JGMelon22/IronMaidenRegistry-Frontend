  ...
  return (
    <>
      <nav className='navbar navbar-expand-md bg-dark py-3' data-bs-theme='dark'>
        ...
        </svg></span><span>Brand</span></a><button data-bs-toggle='collapse' className='navbar-toggler' data-bs-target='#navcol-5'><span className='visually-hidden'>Toggle navigation</span><span className='navbar-toggler-icon'></span></button>
